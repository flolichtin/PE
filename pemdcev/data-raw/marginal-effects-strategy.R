## code to prepare `marginal.effects.strategy` dataset goes here
...
all_me <- marginal.effects$all_me
...
ggsave("output/marginal_effects_strat.png", width = 28, height = 17)

marginal.effects.strategy <- list()
marginal.effects.strategy$me_by_strat <- me_by_strat_o
marginal.effects.strategy$all_plots <- all_strat_plots

usethis::use_data(marginal.effects.strategy, overwrite = TRUE)
