"
* same as apollo.12 but with single education level (mandatory)
* apollo.12 is better
"
...
apollo.13 <- apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)
texreg::screenreg(apollo_tex(apollo.13))

usethis::use_data(apollo.13, overwrite = TRUE)
