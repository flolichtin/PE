...
* universal choice set (availabilities)
"
...
apollo.1 <- apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)
texreg::screenreg(pemdcev::apollo_tex(apollo.1))

usethis::use_data(apollo.1, overwrite = TRUE)
