"
* based on apollo.11 but excluding p-val < 0.05 (see apollo.12.prep)
"
...
apollo.12 <- apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)
texreg::screenreg(apollo_tex(apollo.12))

apollo.12$database <- database
apollo.12$avail <- avail
apollo.12$apollo_probabilities <- apollo_probabilities
apollo.12$apollo_beta <- apollo_beta
apollo.12$apollo_fixed <- apollo_fixed

usethis::use_data(apollo.12, overwrite = TRUE)
