"
* same as apollo.8
* but with outside good (see apollo.5)
"
...
apollo.11.outside <- apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)
texreg::screenreg(apollo_tex(apollo.11.outside))




usethis::use_data(apollo.11.outside, overwrite = TRUE)
