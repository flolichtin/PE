...
# tmp
expl <- modeling_data_2$expl

# Try to activate some variables (pre-multiply with ind)
# Avoid perfect explanatory stuff
...
apollo.8 <- apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)
texreg::screenreg(apollo_tex(apollo.8))

usethis::use_data(apollo.8, overwrite = TRUE)
