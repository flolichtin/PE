"
based on apollo.12 with income interactions
"

## TODO:
## make sure not to exclude groups (dummies)?
...
apollo_beta <- c(
  ...
  # interactions
  # pol_scale_x_income
  b_rplc.r.sll_pol_scale_x_income = 0,
  b_rdc.nd.cmpnst_pol_scale_x_income = 0,
  b_shrt.flghts_pol_scale_x_income = 0,
  b_mdm.flghts_pol_scale_x_income = 0,
  b_lng.flghts_pol_scale_x_income = 0,
  b_dt_pol_scale_x_income = 0,
  b_inslt.rf_pol_scale_x_income = 0,
  b_inslt.fcd_pol_scale_x_income = 0,
  b_rplc.wndws_pol_scale_x_income = 0,
  b_vntltn_pol_scale_x_income = 0,
  b_ht.pmp_pol_scale_x_income = 0,
  b_slr.pnls_pol_scale_x_income = 0,
  b_rdc.tmp_pol_scale_x_income = 0,
  b_crtfct_pol_scale_x_income = 0,
  b_co2.offset_pol_scale_x_income = 0,
  b_undercomp_pol_scale_x_income = 0,

  # ind_concern_x_income
  b_rplc.r.sll_ind_concern_x_income = 0,
  b_rdc.nd.cmpnst_ind_concern_x_income = 0,
  b_shrt.flghts_ind_concern_x_income = 0,
  b_mdm.flghts_ind_concern_x_income = 0,
  b_lng.flghts_ind_concern_x_income = 0,
  b_dt_ind_concern_x_income = 0,
  b_inslt.rf_ind_concern_x_income = 0,
  b_inslt.fcd_ind_concern_x_income = 0,
  b_rplc.wndws_ind_concern_x_income = 0,
  b_vntltn_ind_concern_x_income = 0,
  b_ht.pmp_ind_concern_x_income = 0,
  b_slr.pnls_ind_concern_x_income = 0,
  b_rdc.tmp_ind_concern_x_income = 0,
  b_crtfct_ind_concern_x_income = 0,
  b_co2.offset_ind_concern_x_income = 0,
  b_undercomp_ind_concern_x_income = 0,

  # ind_resp_x_income
  b_rplc.r.sll_ind_resp_x_income = 0,
  b_rdc.nd.cmpnst_ind_resp_x_income = 0,
  b_shrt.flghts_ind_resp_x_income = 0,
  b_mdm.flghts_ind_resp_x_income = 0,
  b_lng.flghts_ind_resp_x_income = 0,
  b_dt_ind_resp_x_income = 0,
  b_inslt.rf_ind_resp_x_income = 0,
  b_inslt.fcd_ind_resp_x_income = 0,
  b_rplc.wndws_ind_resp_x_income = 0,
  b_vntltn_ind_resp_x_income = 0,
  b_ht.pmp_ind_resp_x_income = 0,
  b_slr.pnls_ind_resp_x_income = 0,
  b_rdc.tmp_ind_resp_x_income = 0,
  b_crtfct_ind_resp_x_income = 0,
  b_co2.offset_ind_resp_x_income = 0,
  b_undercomp_ind_resp_x_income = 0,

  # ind_effic_x_income
  b_rplc.r.sll_ind_effic_x_income = 0,
  b_rdc.nd.cmpnst_ind_effic_x_income = 0,
  b_shrt.flghts_ind_effic_x_income = 0,
  b_mdm.flghts_ind_effic_x_income = 0,
  b_lng.flghts_ind_effic_x_income = 0,
  b_dt_ind_effic_x_income = 0,
  b_inslt.rf_ind_effic_x_income = 0,
  b_inslt.fcd_ind_effic_x_income = 0,
  b_rplc.wndws_ind_effic_x_income = 0,
  b_vntltn_ind_effic_x_income = 0,
  b_ht.pmp_ind_effic_x_income = 0,
  b_slr.pnls_ind_effic_x_income = 0,
  b_rdc.tmp_ind_effic_x_income = 0,
  b_crtfct_ind_effic_x_income = 0,
  b_co2.offset_ind_effic_x_income = 0,
  b_undercomp_ind_effic_x_income = 0,

  # ind_exp_x_income
  b_rplc.r.sll_ind_exp_x_income = 0,
  b_rdc.nd.cmpnst_ind_exp_x_income = 0,
  b_shrt.flghts_ind_exp_x_income = 0,
  b_mdm.flghts_ind_exp_x_income = 0,
  b_lng.flghts_ind_exp_x_income = 0,
  b_dt_ind_exp_x_income = 0,
  b_inslt.rf_ind_exp_x_income = 0,
  b_inslt.fcd_ind_exp_x_income = 0,
  b_rplc.wndws_ind_exp_x_income = 0,
  b_vntltn_ind_exp_x_income = 0,
  b_ht.pmp_ind_exp_x_income = 0,
  b_slr.pnls_ind_exp_x_income = 0,
  b_rdc.tmp_ind_exp_x_income = 0,
  b_crtfct_ind_exp_x_income = 0,
  b_co2.offset_ind_exp_x_income = 0,
  b_undercomp_ind_exp_x_income = 0,
...
# remove insig interactions
fix.interactions <-
  apollo.16 %>%
  model_to_df() %>%
  mutate(stars = Heimisc::stars(pvalues)) %>%
  filter(stringr::str_detect(variable, "_x_"),
         stars == "") %>%
  pull(coef.names)

apollo_fixed <- c(apollo_fixed, fix.interactions)
...
apollo_probabilities <- function(apollo_beta, apollo_inputs, functionality = "estimate")
{
  ...
  V[["rplc.r.sll"]] = asc_rplc.r.sll +
    ...
    b_rplc.r.sll_pol_scale_x_income * pol_scale * income +
    b_rplc.r.sll_ind_concern_x_income * ind_concern * income +
    b_rplc.r.sll_ind_resp_x_income * ind_resp * income +
    b_rplc.r.sll_ind_effic_x_income * ind_effic * income +
    b_rplc.r.sll_ind_exp_x_income * ind_exp * income
  ...
  V[["rdc.nd.cmpnst"]] = asc_rdc.nd.cmpnst +
    ...
    b_rdc.nd.cmpnst_pol_scale_x_income * pol_scale * income +
    b_rdc.nd.cmpnst_ind_concern_x_income * ind_concern * income +
    b_rdc.nd.cmpnst_ind_resp_x_income * ind_resp * income +
    b_rdc.nd.cmpnst_ind_effic_x_income * ind_effic * income +
    b_rdc.nd.cmpnst_ind_exp_x_income * ind_exp * income
  ...
  V[["shrt.flghts"]] = asc_shrt.flghts +
    ...
    b_shrt.flghts_pol_scale_x_income * pol_scale * income +
    b_shrt.flghts_ind_concern_x_income * ind_concern * income +
    b_shrt.flghts_ind_resp_x_income * ind_resp * income +
    b_shrt.flghts_ind_effic_x_income * ind_effic * income +
    b_shrt.flghts_ind_exp_x_income * ind_exp * income
  ...
  V[["mdm.flghts"]] = asc_mdm.flghts +
    ...
    b_mdm.flghts_pol_scale_x_income * pol_scale * income +
    b_mdm.flghts_ind_concern_x_income * ind_concern * income +
    b_mdm.flghts_ind_resp_x_income * ind_resp * income +
    b_mdm.flghts_ind_effic_x_income * ind_effic * income +
    b_mdm.flghts_ind_exp_x_income * ind_exp * income
  ...
  V[["lng.flghts"]] = asc_lng.flghts +
    ...
    b_lng.flghts_pol_scale_x_income * pol_scale * income +
    b_lng.flghts_ind_concern_x_income * ind_concern * income +
    b_lng.flghts_ind_resp_x_income * ind_resp * income +
    b_lng.flghts_ind_effic_x_income * ind_effic * income +
    b_lng.flghts_ind_exp_x_income * ind_exp * income
  ...
  V[["dt"]] = asc_dt +
    ...
    b_dt_pol_scale_x_income * pol_scale * income +
    b_dt_ind_concern_x_income * ind_concern * income +
    b_dt_ind_resp_x_income * ind_resp * income +
    b_dt_ind_effic_x_income * ind_effic * income +
    b_dt_ind_exp_x_income * ind_exp * income
  ...
  V[["inslt.rf"]] = asc_inslt.rf +
    ...
    b_inslt.rf_pol_scale_x_income * pol_scale * income +
    b_inslt.rf_ind_concern_x_income * ind_concern * income +
    b_inslt.rf_ind_resp_x_income * ind_resp * income +
    b_inslt.rf_ind_effic_x_income * ind_effic * income +
    b_inslt.rf_ind_exp_x_income * ind_exp * income
  ...
  V[["inslt.fcd"]] = asc_inslt.fcd +
    ...
    b_inslt.fcd_pol_scale_x_income * pol_scale * income +
    b_inslt.fcd_ind_concern_x_income * ind_concern * income +
    b_inslt.fcd_ind_resp_x_income * ind_resp * income +
    b_inslt.fcd_ind_effic_x_income * ind_effic * income +
    b_inslt.fcd_ind_exp_x_income * ind_exp * income
  ...
  V[["rplc.wndws"]] = asc_rplc.wndws +
    ...
    b_rplc.wndws_pol_scale_x_income * pol_scale * income +
    b_rplc.wndws_ind_concern_x_income * ind_concern * income +
    b_rplc.wndws_ind_resp_x_income * ind_resp * income +
    b_rplc.wndws_ind_effic_x_income * ind_effic * income +
    b_rplc.wndws_ind_exp_x_income * ind_exp * income
  ...
  V[["vntltn"]] = asc_vntltn +
    ...
    b_vntltn_pol_scale_x_income * pol_scale * income +
    b_vntltn_ind_concern_x_income * ind_concern * income +
    b_vntltn_ind_resp_x_income * ind_resp * income +
    b_vntltn_ind_effic_x_income * ind_effic * income +
    b_vntltn_ind_exp_x_income * ind_exp * income
  ...
  V[["ht.pmp"]] = asc_ht.pmp +
    ...
    b_ht.pmp_pol_scale_x_income * pol_scale * income +
    b_ht.pmp_ind_concern_x_income * ind_concern * income +
    b_ht.pmp_ind_resp_x_income * ind_resp * income +
    b_ht.pmp_ind_effic_x_income * ind_effic * income +
    b_ht.pmp_ind_exp_x_income * ind_exp * income
  ...
  V[["slr.pnls"]] = asc_slr.pnls +
    ...
    b_slr.pnls_pol_scale_x_income * pol_scale * income +
    b_slr.pnls_ind_concern_x_income * ind_concern * income +
    b_slr.pnls_ind_resp_x_income * ind_resp * income +
    b_slr.pnls_ind_effic_x_income * ind_effic * income +
    b_slr.pnls_ind_exp_x_income * ind_exp * income
  ...
  V[["rdc.tmp"]] = asc_rdc.tmp +
    ...
    b_rdc.tmp_pol_scale_x_income * pol_scale * income +
    b_rdc.tmp_ind_concern_x_income * ind_concern * income +
    b_rdc.tmp_ind_resp_x_income * ind_resp * income +
    b_rdc.tmp_ind_effic_x_income * ind_effic * income +
    b_rdc.tmp_ind_exp_x_income * ind_exp * income
  ...
  V[["crtfct"]] = asc_crtfct +
    ...
    b_crtfct_pol_scale_x_income * pol_scale * income +
    b_crtfct_ind_concern_x_income * ind_concern * income +
    b_crtfct_ind_resp_x_income * ind_resp * income +
    b_crtfct_ind_effic_x_income * ind_effic * income +
    b_crtfct_ind_exp_x_income * ind_exp * income
  ...
  V[["co2.offset"]] = asc_co2.offset +
    ...
    b_co2.offset_pol_scale_x_income * pol_scale * income +
    b_co2.offset_ind_concern_x_income * ind_concern * income +
    b_co2.offset_ind_resp_x_income * ind_resp * income +
    b_co2.offset_ind_effic_x_income * ind_effic * income +
    b_co2.offset_ind_exp_x_income * ind_exp * income
  ...
  V[["undercomp"]] = asc_undercomp +
    ...
    b_undercomp_pol_scale_x_income * pol_scale * income +
    b_undercomp_ind_concern_x_income * ind_concern * income +
    b_undercomp_ind_resp_x_income * ind_resp * income +
    b_undercomp_ind_effic_x_income * ind_effic * income +
    b_undercomp_ind_exp_x_income * ind_exp * income
...
apollo.17 <- apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)
texreg::screenreg(apollo_tex(apollo.17))

apollo.17$apollo_control <- apollo_control
apollo.17$database <- database
apollo.17$avail <- avail
apollo.17$apollo_probabilities <- apollo_probabilities
apollo.17$apollo_beta <- apollo_beta
apollo.17$apollo_fixed <- apollo_fixed

usethis::use_data(apollo.17, overwrite = TRUE)
