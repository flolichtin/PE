...
apollo.3 <- apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)
texreg::screenreg(pemdcev::apollo_tex(apollo.3))


usethis::use_data(apollo.3, overwrite = TRUE)
