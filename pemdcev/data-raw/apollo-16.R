...
apollo.16 <- apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)
texreg::screenreg(apollo_tex(apollo.16))

usethis::use_data(apollo.16, overwrite = TRUE)
